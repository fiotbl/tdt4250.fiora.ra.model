 ...
 * </p>
 * <ul>
 *   <li>{@link tdt4250.fiora.ra.impl.DepartmentImpl#getCourses <em>Courses</em>}</li>
 *   <li>{@link tdt4250.fiora.ra.impl.DepartmentImpl#getStaff <em>Staff</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DepartmentImpl extends MinimalEObjectImpl.Container implements Department {
	...
	public EList<Person> getStaff() {
		if (staff == null) {
			staff = new EObjectContainmentEList<Person>(Person.class, this, RaPackage.DEPARTMENT__STAFF);
		}
		return staff;
	}
